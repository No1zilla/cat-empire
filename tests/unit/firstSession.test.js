...
import { shouldRevealMidgameChrome, shouldOfferDailyNow, shouldSkipBootMenu, getTutorialTargets } from '../../src/game/firstSession.js';

export function runFirstSessionTests() {
  console.log('🧪 Тестирование первой сессии: коты раньше кассы...');
  ...
  console.log('  ✅ Первая сессия: меню пропущено, касса после merge');
}
