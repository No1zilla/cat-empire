...
export const CONFIG = {
  ...
  // TASK-123: поле 4x4. Пять на пять занимало весь экран, и игра читалась как
  // головоломка, а не как место с котами. Освободившийся верх уходит под комнату.
  GRID_SIZE: 4,            // сетка 4x4
  // Бюджет высоты на экране 700: комната 200 + поле 350 + ряд кнопок 72 + низ 78.
  CELL_SIZE: 80,           // 4*80 + 5*6 = 350
  GRID_PADDING: 6,
  ...
  COLORS: {
    ...
    GRID_BG: 0xfff6e2,     // Кремовый лоток поля
    CELL_BG: 0xf3c9cf,     // Коврик кота
...
/** Сколько слотов на поле. Единственный источник: раньше 25 было зашито в семи местах. */
export const SLOT_COUNT = CONFIG.GRID_SIZE * CONFIG.GRID_SIZE;

/**
 * Высота комнаты над полем. Здесь гуляют коты и стоит HUD — то, что превращает
 * экран из головоломки в место с питомцами.
 */
